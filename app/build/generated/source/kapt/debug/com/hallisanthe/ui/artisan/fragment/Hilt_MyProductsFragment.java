...
public abstract class Hilt_MyProductsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyProductsFragment() {
    super();
  }

  Hilt_MyProductsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyProductsFragment_GeneratedInjector) this.generatedComponent()).injectMyProductsFragment(UnsafeCasts.<MyProductsFragment>unsafeCast(this));
    }
  }
