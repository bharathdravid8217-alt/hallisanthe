...
public abstract class Hilt_UploadProductFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UploadProductFragment() {
    super();
  }

  Hilt_UploadProductFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadProductFragment_GeneratedInjector) this.generatedComponent()).injectUploadProductFragment(UnsafeCasts.<UploadProductFragment>unsafeCast(this));
    }
  }
